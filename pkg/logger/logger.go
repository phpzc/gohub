...
func getEncoder() zapcore.Encoder {
	...
	encoderConfig := zapcore.EncoderConfig{
		...
		EncodeLevel:    zapcore.CapitalLevelEncoder,    //日志级别名称大写 如ERROR INFO
		EncodeTime:     customTimeEncoder,              //时间格式 我们自定义为 2006-01-02
	...
	if app.IsLocal() {
		...
		//本地设置内置的console解码器 支持stacktrace 换行
...
// LogIf 当err != nil 时 记录 error 等级的日志
